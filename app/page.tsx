...
<main style={{ backgroundColor: colors.cream }}>
  ...
  <section className="relative min-h-screen overflow-hidden">
    ...
    {/* HEADER */}
    <div className="absolute top-5 left-2 right-8 z-[9999] flex justify-between items-start">
    ...
    {/* TEXT */}
    <div className="relative z-10 flex items-start min-h-screen px-6 pt-40">
      <div className="max-w-3xl text-white">
        ...
        <div className="flex gap-4 mt-10 flex-wrap">
          ...
          <a
            ...
            className="px-8 py-4 rounded-2xl border border-darkGreen text-white"
          >
            Company Profile
          </a>
